...
function fn_pwdfindform_check() {
	 ...
	 document.getElementById("u_email1").disabled= false;
	...
	function fn_checkCode(){
		...
		if (joinCode != inputCode) {
			...
			return;
			 ...
			 document.getElementById("u_email1").disabled= true;
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td><input type="text" name="u_id" id="u_id"placeholder="ID를 입력하세요"></td>
								</tr>
								<tr>
									<th><span>가입한 이름</span></th>
									<td><input type="text" name="u_name" id="u_name" placeholder="이름을 입력하세요."></td>
								</tr>
								<tr>
									<th><span>가입한 핸드폰 번호</span></th>
									<td><input type="text"  class="mobile" name="u_phone" id="u_phone" placeholder="숫자만 입력하세요."></td>
