...
.join_form table select.email_sel_1{
	margin: 0 auto;
	margin-left: 30px;
	height: 25px;
	border: 1px solid #cfcfcf;
...
<body>
	<form name="pwdFind_form" action="${contextPath}/host/h_pwdFind.do" method="post">
	<div class="wrap wd668">
			<div class="container">
				<div class="form_txtInput">
					<h2 class="sub_tit_txt">호스트 비밀번호 찾기</h2>
					<div class="join_form">
						<table>
							<colgroup>
								<col width="30%"/>
							...
							<tbody>
								<tr>
									<th><span>가입한 아이디</span></th>
									<td><input type="text" name="h_id" id="h_id"placeholder="ID를 입력하세요"></td>
								</tr>
								<tr>
									<th><span>가입한 이름</span></th>
									<td><input type="text" name="h_name" id="h_name" placeholder="이름을 입력하세요."></td>
								</tr>
								<tr>
									<th><span>가입한 핸드폰 번호</span></th>
									<td><input type="text"  class="mobile" name="h_phone" id="h_phone" placeholder="숫자만 입력하세요."></td>
								...
								<tr class="email">
									...
									<td><input type="text" class="email_input"
										...
										style="margin: 11px 0px 0px 4px;" class="email_sel_"
					...
					<div class="">
						<button type="button" class="btn_wrap" onClick="fn_pwdfindform_check()">비밀번호 찾기</button>
					</div>
				</div> <!-- form_txtInput E -->
			</div><!-- content E-->
		</div> <!-- container E -->
