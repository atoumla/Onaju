	...
	<div class="wrap wd668">
			<div class="contai1">
				<div class="form_txtInput">
					<h2 class="sub_tit_txt">호스트 회원 탈퇴</h2>
					<p class="exTxt">가입된 회원정보가 모두 삭제됩니다.<br>
					작성하신 게시물은 자동으로 삭제되지 않습니다. <br>
					게시물 삭제를 원하시면 게시물 삭제후 회원탈퇴를 진행 부탁드립니다.<br>
					회원 탈퇴를 진행하시려면 비밀번호를 입력해 주십시오.</p>
					<div class="join_form">
					...
					<div class="noticeBtn2Box">
						<button type="submit" class="noticeBtn2 btn-dark2" onClick="${contextPath}/main/main.do">취소</button>
						<button type="submit" class="noticeBtn2 btn-dark2" onClick="${contextPath}/main/main.do">탈퇴</button>
