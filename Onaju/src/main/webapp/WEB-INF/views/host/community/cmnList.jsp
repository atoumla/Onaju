	...
	<section class="host_notice">
				...
				<div class="noticeSearch-window">
					<form action="">
						<div class="noticeSearch-wrap">
							<label for="noticeSearch" class="blind">내용 검색</label> <input
		...
		<div>
			<button type="submit" class="noticeBtn2 btn-dark2"
				onclick="location.href='${contextPath}/host/community/cmnAticleForm.do'">글쓰기</button>
		</div>
