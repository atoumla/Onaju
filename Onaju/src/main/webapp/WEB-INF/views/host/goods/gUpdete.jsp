		...
		<br>
			...
			<ul>	
				<li class="inf4">&rtrif;체크인
					<form>
				      <p><input type="time"></p>
				      <p><input id="ti" type="submit" value="체크인"></p>
				    </form>
				 <li class="inf4">&rtrif;체크아웃
					<form>
				      <p><input type="time"></p>
				      <p><input id="ti" type="submit" value="체크아웃"></p>
				    </form>  
			</li>
			</ul>
			<ul>		     
				...
				<li class="inf5">&rtrif;요금 설정
					<input type="text" placeholder="요금을 입력하세요." id="recycle_result_amt" value="" onkeyup="inputNumberFormat(this)"/>

					
			</li>
		</ul>
	</div>
	<a href="${contextPath}/webapp/goods1.jsp"><button id="btbt">목록보기</button></a>
	<a href="${contextPath}/webapp/goods1.jsp"><button id="btbt">등록하기</button></a>
</body>
</html>