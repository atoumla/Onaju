	...
	<div class="wrap wd668">
			<div class="container">
				<div class="form_txtInput">
					<h2 class="sub_tit_txt">호스트 아이디 찾기 결과</h2>
					<p class="exTxt">고객님의 아이디 찾기가 성공적으로 이루어졌습니다.<br>
					다음 정보로 가입된 아이디는 아래와 같습니다.</p>
					<div class="join_form">
						<table>
							<colgroup>
								<col width="30%"/>
							...
							<tbody>
								<tr>
									<th><span>아이디</span></th>
									<td style="text-align:center;"><span >${hostInfo.h_id}&nbsp;&nbsp;&nbsp;</span></td>
								</tr>
							</tbody>
						</table>
					...
					<div class="btn_wrap">
						<a href="${contextPath}/host/h_pwdFindForm.do">비밀번호 찾기</a>
					</div>
					</div>
				</div> <!-- form_txtInput E -->
			</div><!-- content E-->
