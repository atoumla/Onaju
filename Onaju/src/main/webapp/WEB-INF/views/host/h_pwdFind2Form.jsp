...
function fn_pwdfindform2_check() {
		...
		f.action = "${contextPath}/host/h_pwdChange.do";
		f.submit();
}
...
<body>
	<form name="pwdFind2_form" action="${contextPath}/host/h_pwdChange.do" method="post">
	<div class="wrap wd668">
			<div class="container">
				<div class="form_txtInput">
					<h2 class="sub_tit_txt">호스트 비밀번호 변경</h2>
					<div class="join_form">
						<table>
							<colgroup>
								<col width="35%"/>
							...
							<tbody>
								<tr>
									...
									<td><input type="password" name="h_pw" id="h_pw" placeholder="영문자+숫자+특수조합(8이상)으로 입력해주세요.">
										<input type="hidden" name="h_id" id="h_id" value="${hostInfo.h_id }"/>
											</td>
								</tr>
								<tr>
									<th><span>신규 비밀번호 확인</span></th>
									<td><input type="password" name="h_repwd" id="h_repwd" placeholder="영문자+숫자+특수조합(8이상)으로 입력해주세요."></td>
								</tr>
